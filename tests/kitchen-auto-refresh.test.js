...
assert(release.includes("appVersion: '3.13.19'"), 'frontend version should be 3.13.18');
assert(release.includes("appVersion: '3.13.19'"), 'backend version should be 3.13.18');
