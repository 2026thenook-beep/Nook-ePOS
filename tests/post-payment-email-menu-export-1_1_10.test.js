...
assert(rel.includes("appVersion: '3.8.6'")); assert(rel.includes("appVersion: '3.8.6'"));
assert(back.includes("var NOOK_VERSION = '3.8.6';"));
console.log('3.8.6 feature tests passed');
